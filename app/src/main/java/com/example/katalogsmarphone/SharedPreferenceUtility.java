...
public class SharedPreferenceUtility {
     ...
     */
    public static List<Hp> getAllTransaksi(Context ctx) {
        String jsonString = getSharedPref(ctx).getString(TRANS_KEY, null);
        List<Hp> trs = new ArrayList<Hp>();
        if (jsonString != null) {
    ...
    /*
        ...
        Perhatikan bahwa data disimpan dalam format JSON String
     */
    private static void saveAllTransaksi(Context ctx, List<Hp> trs) {
     ...
     */
    public static void addTransaksi(Context ctx, Hp tr) {
        List<Hp> trs = getAllTransaksi(ctx);
        trs.add(tr);
        saveAllTransaksi(ctx,trs);
    }

    public static void editTransaksi(Context ctx, Hp tr) {
        List<Hp> trs = getAllTransaksi(ctx);
        for (Hp tre:trs) {
