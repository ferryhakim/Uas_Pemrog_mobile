...
public class FormHpActivity extends AppCompatActivity {
    ...
    final String[] tipeTransaksi = {Hp.REALME, Hp.XIAOMI,Hp.SAMSUNG,Hp.HUAWEI};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_hp);
        inisialisasiView();
    }
