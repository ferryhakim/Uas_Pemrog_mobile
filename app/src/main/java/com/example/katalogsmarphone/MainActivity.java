...
public class MainActivity extends AppCompatActivity {
    ...
    com.example.katalogsmarphone.DaftarHpAdapter adapter;
    List<Hp> daftarTransaksi;
    ...
    private void setupListview() {
        adapter = new com.example.katalogsmarphone.DaftarHpAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, com.example.katalogsmarphone.FormHpActivity.class);
